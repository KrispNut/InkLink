            ...
            children: <Widget> [
              ...
              Row(
                ...
                children: <Widget> [
                  ...
                  Text(textAlign: TextAlign.center,'Sign Up',style: TextStyle(color: Colors.white,fontSize: 60, fontWeight: FontWeight.bold, fontFamily: 'Matrix'),),
                ],
              ),
              const SizedBox(height: 100.0),
              const Padding(
                padding: EdgeInsets.fromLTRB(20,0,0,0),
                child: Align(alignment: Alignment.centerLeft,child: Text('Sign up by using email',style: TextStyle(color: Colors.white,fontSize: 25, fontWeight: FontWeight.bold, fontFamily: 'Matrix'),)),
              ),
                ...
                child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 20),
                      Text('Sign up with Google', style: TextStyle( fontSize: 22, fontWeight: FontWeight.bold, fontFamily: 'Matrix'),),
                    ],
                  ),
                ),
              ),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  ), child: const Text('Sign Up',style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold,fontFamily: 'Matrix'),),
                ),
              ),
            ],
          ),
